...
gdjs.bossfightCode.asyncCallback24183548 = function (runtimeScene, asyncObjectsList) {
...
gdjs.bossfightCode.idToCallbackMap.set(24183548, gdjs.bossfightCode.asyncCallback24183548);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(8), (runtimeScene) => (gdjs.bossfightCode.asyncCallback24183548(runtimeScene, asyncObjectsList)), 24183548, asyncObjectsList);
}
}
...
};gdjs.bossfightCode.userFunc0xc6d4c8 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
};gdjs.bossfightCode.asyncCallback24200452 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.bossfightCode.localVariables);
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "BSRank", false);
}
gdjs.bossfightCode.localVariables.length = 0;
}
gdjs.bossfightCode.idToCallbackMap.set(24200452, gdjs.bossfightCode.asyncCallback24200452);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.bossfightCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.bossfightCode.asyncCallback24200452(runtimeScene, asyncObjectsList)), 24200452, asyncObjectsList);
}
}
...
};gdjs.bossfightCode.asyncCallback24202740 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.bossfightCode.localVariables);
...
gdjs.bossfightCode.idToCallbackMap.set(24202740, gdjs.bossfightCode.asyncCallback24202740);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.bossfightCode.asyncCallback24202740(runtimeScene, asyncObjectsList)), 24202740, asyncObjectsList);
}
}
...
};gdjs.bossfightCode.asyncCallback24206100 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.bossfightCode.localVariables);
...
gdjs.bossfightCode.idToCallbackMap.set(24206100, gdjs.bossfightCode.asyncCallback24206100);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.bossfightCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.bossfightCode.asyncCallback24206100(runtimeScene, asyncObjectsList)), 24206100, asyncObjectsList);
}
}
...
gdjs.bossfightCode.userFunc0xc6d4c8(runtimeScene, objects);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(24190964);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(24195132);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(24209740);
}
}
if (isConditionTrue_0) {
