...
gdjs.copyArray(runtimeScene.getObjects("NewText2"), gdjs.title_32officialCode.GDNewText2Objects2);
{for(var i = 0, len = gdjs.title_32officialCode.GDNewText2Objects2.length ;i < len;++i) {
    gdjs.title_32officialCode.GDNewText2Objects2[i].getBehavior("Text").setText("Sigeon Pex");
}
}
}
...
gdjs.copyArray(runtimeScene.getObjects("NewText2"), gdjs.title_32officialCode.GDNewText2Objects2);
{for(var i = 0, len = gdjs.title_32officialCode.GDNewText2Objects2.length ;i < len;++i) {
    gdjs.title_32officialCode.GDNewText2Objects2[i].getBehavior("Text").setText("Also try Berry Dash!");
}
}
}
...
gdjs.copyArray(runtimeScene.getObjects("NewText2"), gdjs.title_32officialCode.GDNewText2Objects2);
{for(var i = 0, len = gdjs.title_32officialCode.GDNewText2Objects2.length ;i < len;++i) {
    gdjs.title_32officialCode.GDNewText2Objects2[i].getBehavior("Text").setText("Also try BDWG!");
}
}
}
...
gdjs.copyArray(runtimeScene.getObjects("NewText2"), gdjs.title_32officialCode.GDNewText2Objects2);
{for(var i = 0, len = gdjs.title_32officialCode.GDNewText2Objects2.length ;i < len;++i) {
    gdjs.title_32officialCode.GDNewText2Objects2[i].getBehavior("Text").setText("Now with -34% bugs!");
}
}
}
...
gdjs.copyArray(runtimeScene.getObjects("NewText2"), gdjs.title_32officialCode.GDNewText2Objects2);
{for(var i = 0, len = gdjs.title_32officialCode.GDNewText2Objects2.length ;i < len;++i) {
    gdjs.title_32officialCode.GDNewText2Objects2[i].getBehavior("Text").setText("lets play goonie dash!");
}
}
}
...
gdjs.copyArray(runtimeScene.getObjects("NewText2"), gdjs.title_32officialCode.GDNewText2Objects2);
{for(var i = 0, len = gdjs.title_32officialCode.GDNewText2Objects2.length ;i < len;++i) {
    gdjs.title_32officialCode.GDNewText2Objects2[i].getBehavior("Text").setText("Does anybody see this?");
}
}
}
...
gdjs.copyArray(runtimeScene.getObjects("NewText2"), gdjs.title_32officialCode.GDNewText2Objects2);
{for(var i = 0, len = gdjs.title_32officialCode.GDNewText2Objects2.length ;i < len;++i) {
    gdjs.title_32officialCode.GDNewText2Objects2[i].getBehavior("Text").setText("is that carlos the bird");
}
}
}
...
{for(var i = 0, len = gdjs.title_32officialCode.GDNewText2Objects1.length ;i < len;++i) {
    gdjs.title_32officialCode.GDNewText2Objects1[i].getBehavior("Text").setText("HELP IM STUCK IN THE SPLASHTEXT");
}
}
}
...
isConditionTrue_0 = gdjs.evtTools.runtimeScene.sceneJustBegins(runtimeScene);
if (isConditionTrue_0) {
{runtimeScene.getScene().getVariables().getFromIndex(1).setNumber(gdjs.randomInRange(1, 13));
}
